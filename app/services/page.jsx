...
const Services = () => {
  return (
    <>
    <section className='min-h-[80hv] flex-col flex justify-center py-12 xl:py-0 '>
...
{services.map((services, index)=> {
  ...
  <div key={index} className='flex-1 flex flex-col justify-center gap-6 group'>
    <div className='w-full flex justify-between items-center'>
      <div className='text-5xl font-extrabold text-outline text-transparent group-hover:text-outline-hover duration-500'>
        {services.num}
      </div>
